...
if(!is_user_alive(id))
return; 		
if(zp_class_sniper_get(id) || zp_class_survivor_get(id) || zp_class_carlito_get(id))
return;			
...
{
formatex(buffer, charsmax(buffer), "M249 Machine Gun \r(Locked) \y7 AP");
menu_additem(menu, buffer, "6")
}
else if(get_Money(id) <= 7)
{ 
formatex(buffer, charsmax(buffer), "M249 Machine Gun \r(Locked) \d7 AP");
menu_additem(menu, buffer, "6")
}
...
{
formatex(buffer, charsmax(buffer), "SG550 Auto-Sniper Gun \r(Locked) \y10 AP");
menu_additem(menu, buffer, "7")
}
else if(get_Money(id) <= 10)
{ 
formatex(buffer, charsmax(buffer), "SG550 Auto-Sniper Gun \r(Locked) \d10 AP");
menu_additem(menu, buffer, "7")
}
...
{
formatex(buffer, charsmax(buffer), "G3SG1 Auto-Sniper Gun \r(Locked) \y15 AP");
menu_additem(menu, buffer, "8")
}
else if(get_Money(id) <= 15)
{ 
formatex(buffer, charsmax(buffer), "G3SG1 Auto-Sniper Gun \r(Locked) \d15 AP");
menu_additem(menu, buffer, "8")
}
