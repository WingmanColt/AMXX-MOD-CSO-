...
new const Models[][] = {"ZP_Human01", "ZP_Human02", "ZP_VIP02", "ZP_Human04", "ZP_Human05", "ZP_Human06"}
...
{			
if(!zp_class_survivor_get(id) && !zp_class_sniper_get(id) && !zp_class_clown_get(id))
{					
...
ShowSyncHudMsg(id, g_MsgSync2, "Visit Our Site: JustPlay.BG^n[Premium Admin/VIP: 2.40/4.80 - Skype: da.bestyyyy]^n^nPublished:^n[For more info contact with him!]")	
}
}
