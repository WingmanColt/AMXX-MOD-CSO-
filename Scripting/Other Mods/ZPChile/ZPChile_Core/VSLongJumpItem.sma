...
public client_connect(id)longJump[id] = false;
public client_disconnect(id)longJump[id] = false;
public zp_fw_core_cure_post(id)longJump[id] = false;
public zp_fw_core_infect_post(id)
{
if(zp_core_is_first_zombie(id) || zp_class_nemesis_get(id) || zp_class_assassin_get(id))
longJump[id] = true;		
}
...
if (get_gametime() - lastLongJumpTime[id] < time2)
return false;
