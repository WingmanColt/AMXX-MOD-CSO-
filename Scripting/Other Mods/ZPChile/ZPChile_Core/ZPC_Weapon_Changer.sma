...
new g_orig_event1, g_orig_event2, g_orig_event3, g_orig_event4, g_orig_event5, g_orig_event6,
...
set_cd(cd_handle, CD_flNextAttack, get_gametime() + 0.001)
else if(get_user_weapon(id) == CSW_ELITE)
set_cd(cd_handle, CD_flNextAttack, get_gametime() + 0.001)
else if(get_user_weapon(id) == CSW_AWP)
set_cd(cd_handle, CD_flNextAttack, get_gametime() + 0.001)
else if(get_user_weapon(id) == CSW_M249)
set_cd(cd_handle, CD_flNextAttack, get_gametime() + 0.001)
return FMRES_HANDLED
}
public fw_PlaybackEvent(flags, invoker, eventid, Float:delay, Float:origin[3], Float:angles[3], Float:fparam1, Float:fparam2, iParam1, iParam2, bParam1, bParam2)
{
if(!is_user_alive(invoker) || zp_core_is_zombie(invoker))
return FMRES_IGNORED	
...
else if(get_user_weapon(invoker) == CSW_AUG)
{
if(eventid != g_orig_event4)
return FMRES_IGNORED
emit_sound(invoker, CHAN_WEAPON, "weapons/aug-1.wav", VOL_NORM, ATTN_NORM, 0, PITCH_NORM)		
set_weapon_anim(invoker,  random_num(3,5))
make_bullet(invoker)	
} 
...
return FMRES_IGNORED
emit_sound(invoker, CHAN_WEAPON, "weapons/m3-1.wav", VOL_NORM, ATTN_NORM, 0, PITCH_NORM)		
...
return FMRES_IGNORED
emit_sound(invoker, CHAN_WEAPON, "weapons/xm1014-1.wav", VOL_NORM, ATTN_NORM, 0, PITCH_NORM)		
set_weapon_anim(invoker,  random_num(1,2))
make_bullet(invoker)	
} 
...
return FMRES_IGNORED
emit_sound(invoker, CHAN_WEAPON, "weapons/usp-1.wav", VOL_NORM, ATTN_NORM, 0, PITCH_NORM)		
set_weapon_anim(invoker,  random_num(1,2))	
make_bullet(invoker)
} 
...
else if(get_user_weapon(invoker) == CSW_ELITE)
{
if(eventid != g_orig_event9)
return FMRES_IGNORED
emit_sound(invoker, CHAN_WEAPON, "weapons/elite-1.wav", VOL_NORM, ATTN_NORM, 0, PITCH_NORM)		
set_weapon_anim(invoker,  random_num(1,2))	
make_bullet(invoker)
} 
...
else if(get_user_weapon(invoker) == CSW_M249)
{
if(eventid != g_orig_event11)
return FMRES_IGNORED
emit_sound(invoker, CHAN_WEAPON, "weapons/m249-1.wav", VOL_NORM, ATTN_NORM, 0, PITCH_NORM)		
set_weapon_anim(invoker,  random_num(1,2))
make_bullet(invoker)	
} 
