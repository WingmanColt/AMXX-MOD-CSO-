...
cvar_lighting = register_cvar("zp_lighting", "c")
cvar_lighting2 = register_cvar("zp_lighting2", "i")
...
//set_task(5000.0, "before_darkness", _, _, TASK_DARKNESS, "b")
}
...
|| equal(map, "zm_forested") || equal(map, "zm_firezone") || equal(map, "zm_cbble_kamp") || equal(map, "zm_decline2k"))
get_pcvar_string(cvar_lighting2, lighting, charsmax(lighting))	
}
