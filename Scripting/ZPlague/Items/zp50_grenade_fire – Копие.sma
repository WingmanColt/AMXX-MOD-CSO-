...
new g_trailSpr, g_exp1Spr, g_firegibs, g_burning_duration2[33], g_flameSpr, g_exp2Spr 
public plugin_init()
{	
...
g_exp1Spr = engfunc(EngFunc_PrecacheModel, "sprites/ZPlague/eexplo.spr")
g_exp2Spr = engfunc(EngFunc_PrecacheModel, "sprites/ballsmoke.spr")	
g_firegibs = engfunc(EngFunc_PrecacheModel, "sprites/ZPlague/fire_explosion_gib.spr")
}
...
engfunc(EngFunc_WriteCoord, originF[2]+80) // z axis
...
write_byte(TE_EXPLOSION)
engfunc(EngFunc_WriteCoord, originF[0]) // x
engfunc(EngFunc_WriteCoord, originF[1]-10.0) // y
engfunc(EngFunc_WriteCoord, originF[2]) // z
write_short(g_exp2Spr)
write_byte(70)
write_byte(7)
...
Exp(ent)
emit_sound(ent, CHAN_BODY, "ZPlague/explosion1.wav", VOL_NORM, ATTN_NORM, 0, PITCH_NORM);
...
set_task(0.1, "Burn2", player + TASK_FBURN5, _, _, "b")	
}
public Burn2(taskid)
{
...
if (health - 20 > 0)
fm_set_user_health(ID_FBURN5, health - 20)
