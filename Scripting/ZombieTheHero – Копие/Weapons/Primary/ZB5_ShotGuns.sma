...
"sprites/weapon_skull-11_MSBG.txt",
...
switch(had)
{
case BALROG11:Damage = float(get_damage_body(body, 1.5))
...
case SKULL11:Damage = float(get_damage_body(body, random_float(1.0, 1.5)))
case M1887:
{
...
do_attack(Attacker, id, 0, random_float(100.0, 300.0), 0)
}
remove_entity(ent)
}	
//// SCYTHE BLADE SYSTEM ////
...
if(is_player(Owner, 0) || !Get_BitVar(g_IsZombie, id))
return
