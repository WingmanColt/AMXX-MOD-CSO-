...
entity_set_float(iEnt, EV_FL_fuser1, get_gametime() + 1.5)
...
entity_set_edict(iEnt, EV_ENT_owner, id);
entity_set_int(iEnt, EV_INT_iuser2, Next)
entity_set_float(iEnt, EV_FL_fuser1, get_gametime() + 1.5)
...
static ID; ID = entity_get_edict(Ent, EV_ENT_owner)
static Next; Next = entity_get_int(Ent, EV_INT_iuser2)
...
if(is_player(ID, 0))
Check_AttackDamge(Ent, ID, 50.0, random_float(100.0, 200.0))
