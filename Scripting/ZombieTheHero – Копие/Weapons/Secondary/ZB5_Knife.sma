...
#define TASK_RESET_DAMAGE 1952

//THANATOS9
#define TASK_LOOP 1954
#define TASK_END 1955
#define TASK_END_2 1956
...
new Weapons:g_had[33], g_had2[33][Options], g_weapon[10], ef_sprite[4]
...
set_pev(id, pev_framerate, 1.9)
set_weapons_timeidle(id, CSW_KNIFE, 1.9)
...
if(get_player_weapon(id) != CSW_KNIFE || had != BLADE)
return
...
//emit_sound(id, CHAN_AUTO, "ZB5/weapons/balrog9_stab.wav", 1.0, ATTN_NORM, 0, PITCH_NORM)

for(new i = 1; i < get_maxplayers(); i++)
{
if(!is_user_alive(i))
continue
if(entity_range(i, id) > float(300))
continue

do_attack(id, i, 0, float(100), 1)
}
set_task(0.1, "Do_Slashing", id+TASK_SET_DAMAGE)
}
...
emit_sound(id, CHAN_WEAPON, sound[random_num(5, 7)], 1.0, ATTN_NORM, 0, PITCH_NORM)
Check_SlashAttack(id)
g_had2[id][ATTACK] = 0
}
case SWORD:
...
{
case ATTACK_SLASH1:emit_sound(id, CHAN_WEAPON, "ZB5/weapons/dragonsword_hit1.wav", 1.0, ATTN_NORM, 0, PITCH_NORM)
case ATTACK_SLASH2:emit_sound(id, CHAN_WEAPON, "ZB5/weapons/dragonsword_hit2.wav", 1.0, ATTN_NORM, 0, PITCH_NORM)
}
} 
else 
{
...
switch(had)
{
case COMBAT:Max_Distance = float(100)	
case STRONG:Max_Distance = float(110)	
case SKULL9:Max_Distance = float(150)	
case WARHAMMER:Max_Distance = float(145)	
case SWORD:Max_Distance = float(150)	
case THANATOS9:Max_Distance = float(140)	
case BLADE:Max_Distance = float(140)	
}
...
switch(had)
{
case COMBAT:do_attack(id, i, ent, random_float(50.0,100.0), 1)
case STRONG:do_attack(id, i, ent, random_float(100.0,200.0), 1)
case SKULL9:do_attack(id, i, ent, random_float(200.0,400.0), 1)
case SWORD:do_attack(id, i, ent, random_float(100.0,200.0), 1)
case WARHAMMER:do_attack(id, i, ent, random_float(200.0,500.0), 1)
case THANATOS9:do_attack(id, i, ent, random_float(200.0, 300.0), 1)
case BLADE:do_attack(id, i, ent, random_float(200.0, 300.0), 1)
}
}
}	
