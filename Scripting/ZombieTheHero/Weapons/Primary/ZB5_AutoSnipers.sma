...
set_pdata_int(ent, m_iClip, iClip + j, WEAP_LINUX_XTRA_OFF)
...
do_attack(Attacker, Victim, 0, random_float(200.0, 500.0), 1)
}
...
do_attack(Attacker, i, 0, random_float(500.0, 1000.0))
}	
}
...
{
static i; i = -1
while ((i = engfunc(EngFunc_FindEntityInSphere, i, Origin, 200.0)) != 0)
{
//if(!is_valid_ent(i))
//continue;
...
do_attack(Attacker, i, 0, random_float(200.0, 500.0))
}
}
...
{
do_attack(id, pHit1, 0, float(300), 0)
...
{
do_attack(id, pHit2, 0, float(200), 0)
...
{
do_attack(id, pHit3, 0, float(100), 0)
...
if(is_valid_ent(pHit4)) do_attack(id, pHit4, 0, float(300), 0)
