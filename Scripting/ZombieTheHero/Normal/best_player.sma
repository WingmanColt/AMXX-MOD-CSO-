...
g_msg = zp_get_synchud_id(SYNCHUD_HUMAN_SKILL)
}
...
set_hudmessage(200, 145, 0, -1.0, 0.150, 2, 4.0, 1.0) // 0.125
ShowSyncHudMsg(0, g_msg, "^nBest player for this round is %s", g_szBestPlayerName)
set_task(0.5, "HUD1", 0)
}
for(i = 0; i < iPlayersNum; i++)
{
...
{	
set_hudmessage(200, 145, 0, -1.0, 0.150, 2, 4.0, 1.0) // 0.125
ShowSyncHudMsg(0, g_msg, "^n^nHeadShots: %i", g_iPlayerHeadShots[g_iBestPlayer])	
}
