...
g_class = zb5_register_zclass("Light Zombie", "\y(Invisible & Leap)", 0, 1, 3, 3500, 1, 1)
}
...
cs_set_player_view_model(id, CSW_KNIFE, "models/ZB5/Claws/v_ZB5_Light.mdl")	
EmitSound(id, CHAN_VOICE, ZombieSound[5])
}
...
EmitSound(id, CHAN_VOICE, ZombieSound[6])
set_fov(id, 100)
}
