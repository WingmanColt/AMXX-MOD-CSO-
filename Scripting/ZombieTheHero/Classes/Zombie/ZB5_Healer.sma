...
g_class = zb5_register_zclass("Voodoo", "\y(Recovery & Device)", 0, 0, 2, 8000, 1, 1)
}
...
EmitSound(i, CHAN_VOICE, zb5_get_zombie_info(i, FEMALE) ? ZombieSound[3] : ZombieSound[2])
}
}
...
EmitSound(Ent, CHAN_VOICE, ZombieSound[0])
