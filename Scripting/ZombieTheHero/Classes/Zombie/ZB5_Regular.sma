...
g_class = zb5_register_zclass("Regular", "\y(FastRun)", 0, 0, 2, 6000, 1, 0)
}
...
set_rendering(id)
set_rendering(id, kRenderFxGlowShell, 100, 5, 5, kRenderNormal, 0)

set_fov(id, 115)
EmitSound(id, CHAN_VOICE, ZombieSound[4])
...
EmitSound(id, CHAN_VOICE, ZombieSound[random_num(5, 6)])
}
