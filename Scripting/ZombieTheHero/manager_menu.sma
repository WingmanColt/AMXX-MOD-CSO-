...
formatex(szText, charsmax(szText), "^"%s^" ^"%s^" ^"bfjn^" ^"a^"", g_PlayerInfo[g_PlayerInfo[id][g_iChoosen]][g_szName], szData);
write_file(g_szDataDir[DIR_USERS], szText);
...
{
delete_line(g_szDataDir[DIR_USERS], iLine);
