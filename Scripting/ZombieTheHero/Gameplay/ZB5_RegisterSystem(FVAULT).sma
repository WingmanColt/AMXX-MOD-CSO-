...
set_task(1.0, "Pre_Menu", id+TASK_MENU)
...
formatex(Temp_String, sizeof(Temp_String), !g_registered[id] ? "Welcome to CMS-BG.eu | Zombie: The Hero +FREE VIP^n^n You should ^"Register^" or ^"Join as Guest^"^n Choose from menu to Continue (if you can't see menu click ^"M^") !^n^n Visit: www.CMS-BG.eu" : "Welcome to CMS-BG.eu | Zombie: The Hero +FREE VIP^n^n You should ^"Login^" to your account to play! Choose from menu ^"Login^" and write your Password to continue.^n^n Visit: www.CMS-BG.eu")
...
if(!g_logged[id] && !g_registered[id]) 
{
menu_account(id)
